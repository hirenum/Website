                ...
                <svg className="flex-shrink-0 w-5 h-5 mt-0.5" viewBox="0 0 24 24" fill="none" stroke="url(#tickGradient)" strokeWidth={3}>
                  <defs>
                    <linearGradient id="tickGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                      ...
                      <stop offset="70%" stopColor="#1BB8BD" />
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="relative group">
                    <input
                      ...
                      placeholder="Name"
                    />
                    <div className="h-[1px] bg-[#1BB8BD]/15 group-focus-within:bg-[#1BB8BD] transition-colors duration-300"></div>
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    />
                    <div className="h-[1px] bg-[#1BB8BD]/15 group-focus-within:bg-[#1BB8BD] transition-colors duration-300 mb-6 sm:mb-8"></div>
                  </div>
