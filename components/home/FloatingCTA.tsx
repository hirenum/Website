...
const FloatingCTA: React.FC<FloatingCTAProps> = memo(({ scrollToSection }) => (
  <div className="fixed bottom-3 right-3 sm:bottom-4 sm:right-4 md:bottom-6 md:right-6 z-40">
    <button 
      ...
      className="bg-gradient-to-r from-[#A9318A] to-[#DC0078] dark:from-[#A9318A] dark:to-[#DC0078] text-white font-bold py-1.5 px-3 sm:py-2 sm:px-4 md:py-2.5 md:px-5 lg:py-3 lg:px-6 rounded-full shadow-lg shadow-[#A9318A]/40 dark:shadow-[#DC0078]/30 hover:shadow-[0_0_30px_rgba(169,49,138,0.6)] dark:hover:shadow-[0_0_30px_rgba(220,0,120,0.6)] transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 flex items-center gap-1 sm:gap-1.5 md:gap-2 group relative overflow-hidden font-btn text-[10px] sm:text-xs md:text-sm lg:text-base"
    >
